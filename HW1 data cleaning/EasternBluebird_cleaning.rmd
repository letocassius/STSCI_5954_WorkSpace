...
* How Fine-Grained is the Map? What is the spatial resolution? (e.g., Does one square represent $30$ meters, $100$ meters, or more?)
* When Was the Picture Taken? What is the temporal coverage? (e.g., Is the land cover from $2010$, $2020$, or an average over a decade?)
* How Far Did They Look? What buffer size was used? (e.g., When measuring 'forest nearby,' did they look in a $50$-meter circle, a $500$-meter circle, or a different size?)
