...
The original goal of this project was to explore which environmental factors are related to where Eastern Bluebirds are found. By comparing locations where the birds were present or absent, we aimed to identify habitat characteristics that might influence sightings and decide which variables are useful for building a future prediction model. This early analysis helps us understand the data, spot irrelevant or uninformative features, and guide the next steps of the project. 
